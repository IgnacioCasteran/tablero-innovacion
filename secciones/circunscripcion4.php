...
<head>
  ...
  <title>IVª Circunscripción Judicial</title>
...
<body>
  ...
  <div class="container py-5 text-center">
    <h2 class="mb-4">IVª Circunscripción Judicial</h2>

    <div class="row g-4 justify-content-center">
      <div class="col-md-6">
        <a href="oficina-penal4.php" class="text-decoration-none text-dark">
          <div class="card shadow-sm border-0 p-4">
            <h5 class="fw-bold mb-0">Judicial Penal</h5>
          </div>
        </a>
      </div>
    </div>
