...
$carpeta = __DIR__ . '/../uploads/objetos/';
$mensaje = "";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['archivo']) && !isset($_POST['eliminar'])) {
    if ($_FILES['archivo']['error'] === UPLOAD_ERR_OK) {
        ...
        if ($ext === 'pdf') {
            ...
            // Normalizar nombre y agregar sufijo si ya existe
        ...
        header("Location: objetos-secuestrados.php");
        exit();
    }
}
...
<head>
    ...
    <title>Oficina de Objetos Secuestrados</title>
    ...
    <style>
        ...
        /* Input y botones más táctiles en móvil */
...
<body>
    <div class="container py-4 py-md-5">
        <h2 class="mb-4 text-center text-danger">Oficina de Objetos Secuestrados</h2>
                ...
                <?php else: ?>
                                ...
                                <?php foreach ($archivos as $archivo): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-nowrap">
                                            <a href="../uploads/objetos/<?= rawurlencode($archivo) ?>" target="_blank" class="btn btn-sm btn-primary">Ver</a>
                    ...
                    <div id="cards-lista" class="d-md-none">
                        <?php foreach ($archivos as $archivo): ?>
                            ...
                            $fecha = date("d/m/Y", filemtime($rutaCompleta));
                            ?>
                            <div class="os-card" data-nombre="<?= htmlspecialchars(mb_strtolower($archivo)) ?>">
                                <div class="os-title"><?= htmlspecialchars($archivo) ?></div>
                                <div class="os-row">
                                    <div><strong>Fecha:</strong> <?= htmlspecialchars($fecha) ?></div>
                                    <div class="full os-actions">
                                        <a href="../uploads/objetos/<?= rawurlencode($archivo) ?>" target="_blank" class="btn btn-sm btn-primary flex-fill">Ver</a>
    ...
    <script>
        ...
        document.getElementById("buscador").addEventListener("keyup", function() {
            ...
            // Cards
            const cards = document.querySelectorAll("#cards-lista .os-card");
            cards.forEach(card => {
