        ...
        <div class="d-flex flex-column align-items-center mb-4">
            <a href="index.php" class="text-decoration-none text-dark text-center">
                ...
                <div class="row g-4 justify-content-center">
                    ...
                    <div class="col-md-5">
                        <?php if ($IS_COORD): ?>
                            <?php disabled_link('Proyectos', 'icons/icon-proyectos.png'); ?>
                        <?php else: ?>
                    ...
                    <div class="col-md-5">
                        <?php if ($IS_COORD): ?>
                            <?php disabled_link('Intervenciones Psicosociales', 'icons/psychology.png'); ?>
                        <?php else: ?>
                    ...
                    <div class="col-md-5">
                        <?php if ($IS_COORD): ?>
                            <?php disabled_link('Laboratorio de Innovación Judicial', 'icons/icon-laboratorio.png'); ?>
                        <?php else: ?>
                    ...
                    <div class="col-md-5">
                        <?php if ($IS_COORD): ?>
                            <?php disabled_link('SGC', 'icons/icon-sgc.png'); ?>
                        <?php else: ?>
                    ...
                    <div class="col-12">
                        <?php if ($IS_COORD): ?>
                            <?php disabled_link('Agenda', 'icons/icon-agenda.png'); ?>
                        <?php else: ?>
